  ...
  describe GitCopy::DefaultStrategy do
    ...
    describe "#test" do
      it "should call test for repo HEAD" do
        ...
        context.expects(:test).with " [ -f /path/to/repo/.git/HEAD ] "
    ...
    describe "#clone" do
      it "should run git clone" do
        ...
        context.expects(:execute).with(:git, :clone, '--verbose', '--recursive', '--shallow-submodules', :url, :path)
      ...
      it "should run git clone in shallow mode" do
        ...
        context.expects(:execute).with(:git, :clone, '--verbose', '--recursive', '--shallow-submodules', "--depth", '1', '--no-single-branch', :url, :path)
